...
@Component({
  templateUrl: 'order-read-dialog.component.html'
})

export class OrderReadDialogComponent {
  ...
  constructor(private dialog: MatDialog, private dialogRef: MatDialogRef<OrderReadDialogComponent>, private message: MatSnackBar,
